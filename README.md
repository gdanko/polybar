...
### CPU Usage
This module shows CPU information with three available output formats that can be toggled by clicking the item in the bar.

#### Output Formats
1. `user 0.99%, sys 0.46%, idle 98.43%`
2. `16 x Ryzen 7 5700U @ 4.37 GHz`
3. `load 0.20,  0.27,  0.44`
